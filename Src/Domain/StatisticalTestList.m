...
@implementation StatisticalTestList
...
-(id) initWithSize:(int const)theSize
{
    self = [super init];
    if (self) {
        statisticalTestList = [[NSMutableArray alloc] initWithCapacity:theSize];
    }
    return self;
}
