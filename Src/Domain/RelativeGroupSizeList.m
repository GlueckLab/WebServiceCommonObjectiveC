...
#import "RelativeGroupSizeList.h"
...
@implementation RelativeGroupSizeList
...
-(id) initWithListSize:(int const)theSize
{
    self = [super init];
    if (self) {
        relativeGroupSizeList = [[NSMutableArray alloc] initWithCapacity:theSize];
    }
    return self;
}
